...
import org.example.demo3.exception.ProductNotFoundException;
...
//    }
    ...
    // вариант когда метод возвращает OK, а в случае если нет по id. то сервис выкинет исключение,
    // который отработает перехватчик ExceptionHandler
    @GetMapping("/{id}")
    public ResponseEntity<Product> getProduct(@PathVariable("id") Long id) {
